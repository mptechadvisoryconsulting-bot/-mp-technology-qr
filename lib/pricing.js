...
export const plans = [
  {
    ...
    limits: "25 QR codes, 3 users, basic analytics",
    dynamicLimit: 25,
    scanLimit: 2500,
    userLimit: 3,
    ...
    features: ["14-day free trial", "25 dynamic QR codes", "3 users", "Basic analytics"],
  },
  {
    id: "professional",
    name: "Professional",
  ...
  },
  {
    ...
    limits: "500 QR codes, 500 users, API access",
    dynamicLimit: 500,
    scanLimit: 100000,
    userLimit: 500,
    ...
    features: ["14-day free trial", "500 dynamic QR codes", "500 users", "API access", "Bulk uploads", "Team permissions"],
  },
  {
    id: "enterprise",
    name: "Enterprise",
